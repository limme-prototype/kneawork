...
export function AiWorkflowGeneratorDialog({
  ...
  const sampleDraftTemplate: ExtendedTemplate = {
    ...
    description:
      "Standard procurement process generated by AI draft assistant for goods, services, and vendor orders.",
    category: "purchase",
    ...
    routeSteps: [
      {
        ...
        assigneeName: "Vanna",
        responsibility:
          "Verify supplier quotation against market rates and check budget allocation.",
        decisionType: "single",
        dueDays: 1,
        onOverdue: "remind",
      },
